    ...
    return (
        <div className='usage_page'>
            <div className='vehicle_cards_bar'>
                ...
                <hr></hr>
                <div className='vehicle_cards_text'>
                    <Link to="/truckcontrol/efficiency" className="vehicle_link {activeButton === 'Efficiency' ? 'active' : ''}"
                                ...
                                <div className='alert_access'>
                                    <div className='alert_scard'>
                                        <button className='alert_scard_button'>
                                            <span className='alert_scard_text'> Tire Pressure</span><br />
                                            <span className='alert_scard_stext'>Abnormal Tire pressure</span><br /><br />
                                            <span className='alert_scard_mt'>{tirePressure} / 80-100 PSI</span>
                                        </button>
                                    </div>
                                    <div className='alert_scard'>
                                        <button className='alert_scard_button'>
                                            <span className='alert_scard_text'>  Brake System</span><br />
                                            <span className='alert_scard_stext'>Fluid Levels</span><br /><br />
                                            <span className='alert_scard_mt'>{brakeHealth} / Full</span>
                                        </button>
                                    </div>
                                    <div className='alert_scard'>
                                        <button className='alert_scard_button'>
                                            <span className='alert_scard_text'> Engine Health</span><br />
                                            <span className='alert_scard_stext'>Temperature levels</span><br /><br />
                                            <span className='alert_scard_mt'>{engineTemp} / 90 - 105 C</span>
                                        </button>
                                    </div>
                                    <div className='alert_scard'>
                                        <button className='alert_scard_button'>
                                            <span className='alert_scard_text'>  Battery Health</span><br />
                                            <span className='alert_scard_stext'>Battery Voltage Levels</span><br /><br />
                                            <span className='alert_scard_mt'>{batteryHealth} / 13 - 15 V</span>
                                        </button>
                                    </div>
                                    <div className='alert_scard'>
                                        <button className='alert_scard_button'>
                                            <span className='alert_scard_text'>  Fuel System</span><br />
                                            <span className='alert_scard_stext'>Low Fuel Level</span><br /><br />
                                            <span className='alert_scard_mt'>{fuelLevel} / 187 L</span>
                                        </button>
                                    </div>
                                </div>
                                    ...
                                    <tbody>
                                        {collisionHistory.map((collision, index) => (
                                            <tr key={index}>
                                                ...
                                                <td>
                                                    <img src="/images/note.png" className='note_ic' onClick={(event) => handleIconClick(collision.description, event)} />
                                                </td>
                                            </tr>
                                        ))}
                                    </tbody>
