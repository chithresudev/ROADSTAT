...
function MaintenancePage({ updateHeader, updateButton }) {
  ...
  const filteredtransmissionData = transmissionData.reduce(
    (acc, transmission) => {
  ...
  return (
    <div className="maintenance-main">
      <div className="maintenance-topcards">
        <div
          className={`maintenance-scard ${
            activeButton === "Engine Health" ? "active" : ""
          }`}
        >
          <button
            className="maintenance-scard-button"
            onClick={() => handleButtonClick("Engine Health")}
          >
            <Link className="maintenance-scard-link">
              <img
                src="/images/eh.png"
                alt="Home"
                className="maintenance-scard-icon"
              />
        ...
        <div
          className={`maintenance-scard ${
            activeButton === "Brake System" ? "active" : ""
          }`}
        >
          <button
            className="maintenance-scard-button"
        ...
        <div
          className={`maintenance-scard ${
            activeButton === "Fuel System" ? "active" : ""
          }`}
        >
          <button
            className="maintenance-scard-button"
            onClick={() => handleButtonClick("Fuel System")}
          >
            <Link className="maintenance-scard-link">
              <img
                src="/images/fs.png"
        ...
        <div
          className={`maintenance-scard ${
            activeButton === "Tire Health" ? "active" : ""
          }`}
        >
          <button
            className="maintenance-scard-button"
            onClick={() => handleButtonClick("Tire Health")}
          >
            <Link className="maintenance-scard-link">
              <img
                src="/images/th.png"
        ...
        <div
          className={`maintenance-scard ${
            activeButton === "Battery Status" ? "active" : ""
          }`}
        >
          <button
            className="maintenance-scard-button"
            onClick={() => handleButtonClick("Battery Status")}
          >
            <Link className="maintenance-scard-link">
              <img
                src="/images/bts.png"
        ...
        <div
          className={`maintenance-scard ${
            activeButton === "Transmission" ? "active" : ""
          }`}
        >
          <button
            className="maintenance-scard-button"
            onClick={() => handleButtonClick("Transmission")}
          >
            <Link className="maintenance-scard-link">
              <img
                src="/images/tr.png"
      ...
      {activeButton === "Engine Health" && (
        <div className="maintenance-card">
          <table className="table table_content">
            <thead>
              <tr>
                <th>Vehicle No</th>
                <th>RMP</th>
            ...
            <tbody className="hoverrow">
              {filteredEngineHealthData.length > 0 ? (
                filteredEngineHealthData.map((engine, index) => (
                  <tr
                    key={index}
                    className={selectedRowIndex === index ? "selected-row" : ""}
                    onClick={() => handleRowClick(index, engine.truckId)}
                  >
      ...
      {activeButton === "Brake System" && (
        <div className="maintenance-card">
          <table className="table table_content">
            ...
            <tbody className="hoverrow">
              {filteredbrakeSystemData.length > 0 ? (
                filteredbrakeSystemData.map((brake, index) => (
                  <tr
                    key={index}
                    className={selectedRowIndex === index ? "selected-row" : ""}
                    onClick={() => handleRowClick(index, brake.truckId)}
                  >
                    <td>{brake.truckId}</td>
      ...
      {activeButton === "Fuel System" && (
        <div className="maintenance-card">
          <table className="table table_content">
            ...
            <tbody className="hoverrow">
              {filteredfuelSystemData.length > 0 ? (
                filteredfuelSystemData.map((fuel, index) => (
                  <tr
                    key={index}
                    className={selectedRowIndex === index ? "selected-row" : ""}
                    onClick={() => handleRowClick(index, fuel.truckId)}
                  >
                    <td>{fuel.truckId}</td>
      ...
      {activeButton === "Tire Health" && (
        <div className="maintenance-card">
          <table className="table table_content">
            ...
            <tbody className="hoverrow">
              {filteredtireHealthData.length > 0 ? (
                filteredtireHealthData.map((tire, index) => (
                  <tr
                    key={index}
                    className={selectedRowIndex === index ? "selected-row" : ""}
                    onClick={() => handleRowClick(index, tire.truckId)}
                  >
                    <td>{tire.truckId}</td>
      ...
      {activeButton === "Battery Status" && (
        <div className="maintenance-card">
          <table className="table table_content">
            ...
            <tbody className="hoverrow">
              {filteredbatteryStatusData.length > 0 ? (
                filteredbatteryStatusData.map((battery, index) => (
                  <tr
                    key={index}
                    className={selectedRowIndex === index ? "selected-row" : ""}
                    onClick={() => handleRowClick(index, battery.truckId)}
                  >
                    ...
                    <td>
                      {new Date(battery.lastReplace).toLocaleDateString()}
                    </td>
                  </tr>
                ))
              ) : (
              ...
              {filteredtransmissionData.length > 0 ? (
                filteredtransmissionData.map((transmission, index) => (
                  <tr
                    key={index}
                    className={selectedRowIndex === index ? "selected-row" : ""}
                    onClick={() => handleRowClick(index, transmission.truckId)}
                  >
